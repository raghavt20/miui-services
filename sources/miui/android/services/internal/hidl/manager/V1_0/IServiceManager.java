package miui.android.services.internal.hidl.manager.V1_0;
...
public interface IServiceManager extends IBase {
    ...
    public static final class Proxy implements IServiceManager {
        ...
        @Override // miui.android.services.internal.hidl.manager.V1_0.IServiceManager, miui.android.services.internal.hidl.base.V1_0.IBase
        ...
        @Override // miui.android.services.internal.hidl.manager.V1_0.IServiceManager
    ...
    public static abstract class Stub extends HwBinder implements IServiceManager {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-123, CommunicationUtil.KEYBOARD_FLASH_ADDRESS, CommunicationUtil.SEND_REPORT_ID_LONG_DATA, -118, 13, 21, -25, -5, 46, -28, 92, 82, -47, -5, -117, -113, -45, -63, 60, CommunicationUtil.COMMAND_AUTH_51, 62, 99, -57, -116, 74, CommunicationUtil.COMMAND_CHECK_MCU_STATUS, -1, -122, -124, 12, -10, -36}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, CommunicationUtil.RESPONSE_TYPE, 19, -109, 36, -72, 59, CommunicationUtil.MCU_ADDRESS, -54, 76}));
        }
