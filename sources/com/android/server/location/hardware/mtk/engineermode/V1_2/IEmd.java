...
public interface IEmd extends com.android.server.location.hardware.mtk.engineermode.V1_1.IEmd {
    ...
    public static final class Proxy implements IEmd {
        public static final String INTF_EMD_1_2 = "vendor.mediatek.hardware.engineermode@1.2::IEmd";
        ...
        public int btIsEmSupport() throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(INTF_EMD_1_2);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
                ...
                default:
                    switch (i) {
                        ...
                        case 46:
                            ...
                            return;
                        case 47:
                            hwParcel.enforceInterface(Proxy.INTF_EMD_1_2);
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (Proxy.INTF_EMD_1_2.equals(str)) {
                return this;
            }
            return null;
        }
    ...
    static IEmd asInterface(IHwBinder iHwBinder) {
        ...
        IEmd queryLocalInterface = iHwBinder.queryLocalInterface(Proxy.INTF_EMD_1_2);
    ...
    static IEmd getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_2, str));
    }

    static IEmd getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_2, str, z));
    }
