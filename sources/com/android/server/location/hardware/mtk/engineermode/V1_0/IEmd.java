package com.android.server.location.hardware.mtk.engineermode.V1_0;
...
public interface IEmd extends IBase {
    ...
    public static final class Proxy implements IEmd {
        public static final String INTF_EMD_1_0 = "vendor.mediatek.hardware.engineermode@1.0::IEmd";
        ...
        public int btDoTest(int i, int i2, int i3, int i4, int i5, int i6, int i7) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(INTF_EMD_1_0);
        ...
        @Override // com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public boolean getFilePathListWithCallBack(String str, IEmCallback iEmCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(INTF_EMD_1_0);
            hwParcel.writeString(str);
        ...
        @Override // com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public boolean sendToServerWithCallBack(String str, IEmCallback iEmCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(INTF_EMD_1_0);
            hwParcel.writeString(str);
            hwParcel.writeStrongBinder(iEmCallback == null ? null : iEmCallback.asBinder());
        ...
        @Override // com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public void setCallback(IEmCallback iEmCallback) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(INTF_EMD_1_0);
            hwParcel.writeStrongBinder(iEmCallback == null ? null : iEmCallback.asBinder());
            HwParcel hwParcel2 = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-66, -27, CommunicationUtil.COMMAND_MCU_BOOT, -107, 121, -115, -5, -113, -11, 28, 119, -105, 121, -100, 105, -29, 86, 105, -79, 32, -9, 25, CommunicationUtil.COMMAND_KB_NFC, -117, -93, -97, -29, -30, -10, -48, CommunicationUtil.SEND_REPORT_ID_LONG_DATA, -100}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, CommunicationUtil.RESPONSE_TYPE, 19, -109, 36, -72, 59, CommunicationUtil.MCU_ADDRESS, -54, 76}));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(Proxy.INTF_EMD_1_0, miui.android.services.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public final String interfaceDescriptor() {
            return Proxy.INTF_EMD_1_0;
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(Proxy.INTF_EMD_1_0);
                    setCallback(IEmCallback.asInterface(hwParcel.readStrongBinder()));
                ...
                case 3:
                    hwParcel.enforceInterface(Proxy.INTF_EMD_1_0);
                    boolean sendToServerWithCallBack = sendToServerWithCallBack(hwParcel.readString(), IEmCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                default:
                    switch (i) {
                        ...
                        case 45:
                            hwParcel.enforceInterface(Proxy.INTF_EMD_1_0);
                            boolean filePathListWithCallBack = getFilePathListWithCallBack(hwParcel.readString(), IEmCallback.asInterface(hwParcel.readStrongBinder()));
                            hwParcel2.writeStatus(0);
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (Proxy.INTF_EMD_1_0.equals(str)) {
                return this;
            }
            return null;
        }
    ...
    static IEmd asInterface(IHwBinder iHwBinder) {
        ...
        IEmd queryLocalInterface = iHwBinder.queryLocalInterface(Proxy.INTF_EMD_1_0);
    ...
    static IEmd getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_0, str));
    }

    static IEmd getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_0, str, z));
    }
