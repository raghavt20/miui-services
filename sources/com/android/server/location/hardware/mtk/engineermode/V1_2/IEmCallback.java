package com.android.server.location.hardware.mtk.engineermode.V1_2;
...
public interface IEmCallback extends com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback {
    ...
    public static final class Proxy implements IEmCallback {
        public static final String INTF_EM_CALLBACK_1_2 = "vendor.mediatek.hardware.engineermode@1.2::IEmCallback";
    ...
    public static abstract class Stub extends HwBinder implements IEmCallback {
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (Proxy.INTF_EM_CALLBACK_1_2.equals(str)) {
                return this;
            }
            return null;
        }
    ...
    static IEmCallback asInterface(IHwBinder iHwBinder) {
        ...
        IEmCallback queryLocalInterface = iHwBinder.queryLocalInterface(Proxy.INTF_EM_CALLBACK_1_2);
    ...
    static IEmCallback getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EM_CALLBACK_1_2, str));
    }

    static IEmCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EM_CALLBACK_1_2, str, z));
    }
