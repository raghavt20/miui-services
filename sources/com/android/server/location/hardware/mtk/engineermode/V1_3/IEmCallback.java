...
import com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback;
import com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback;
...
public interface IEmCallback extends com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback {
    @Override // com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmCallback
    IHwBinder asBinder();
    ...
    public static final class Proxy implements IEmCallback {
        public static final String INTF_EM_CALLBACK_1_3 = "vendor.mediatek.hardware.engineermode@1.3::IEmCallback";
        ...
        @Override // com.android.server.location.hardware.mtk.engineermode.V1_3.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmCallback
    ...
    public static abstract class Stub extends HwBinder implements IEmCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-108, -92, -18, 61, -63, 28, 126, -84, 4, -103, -126, -90, -54, -107, 7, 27, -10, CommunicationUtil.KEYBOARD_COLOR_WHITE, 106, 111, 1, -65, CommunicationUtil.COMMAND_AUTH_51, -66, -26, 84, 15, 122, -6, -18, -100, 68}, new byte[]{70, 86, CommunicationUtil.COMMAND_KB_BATTERY_LEVEL, 42, -81, -15, -78, -17, 26, -30, -76, -45, -62, 91, -3, -72, 75, 62, -60, 125, 74, 92, 94, 107, -110, -87, 1, -29, -100, -113, CommunicationUtil.PAD_ADDRESS, -8}, new byte[]{14, 83, 28, -4, CommunicationUtil.COMMAN_PAD_EXTERNAL_FLAG, 98, -79, -83, 71, 92, -81, 120, CommunicationUtil.TOUCHPAD_ADDRESS, 84, 28, 92, 58, 73, -62, -33, -63, 120, CommunicationUtil.TOUCHPAD_ADDRESS, 9, -60, 101, -42, 36, 34, 68, -3, -34}, new byte[]{-27, 112, 36, 113, -82, 20, -75, -113, 38, -39, 101, -23, CommunicationUtil.PAD_ADDRESS, -21, 119, CommunicationUtil.COMMAND_KEYBOARD_UPGRADE_STATUS, -10, CommunicationUtil.COMMAND_KB_FEATURE_SLEEP, -108, 42, CommunicationUtil.SEND_RESTORE_COMMAND, -83, 7, -109, CommunicationUtil.COMMAND_G_SENSOR, 101, -90, CommunicationUtil.COMMAND_G_SENSOR, -55, 73, 93, -105}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, CommunicationUtil.RESPONSE_TYPE, 19, -109, 36, -72, 59, CommunicationUtil.MCU_ADDRESS, -54, 76}));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_3.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmCallback
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(Proxy.INTF_EM_CALLBACK_1_3, IEmCallback.Proxy.INTF_EM_CALLBACK_1_2, IEmCallback.Proxy.INTF_EM_CALLBACK_1_1, IEmCallback.Proxy.INTF_EM_CALLBACK_1_0, IBase.kInterfaceName));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_3.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_2.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_1.IEmCallback, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmCallback
        public final String interfaceDescriptor() {
            return Proxy.INTF_EM_CALLBACK_1_3;
        }
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (Proxy.INTF_EM_CALLBACK_1_3.equals(str)) {
                return this;
            }
            return null;
        }
    ...
    static IEmCallback asInterface(IHwBinder iHwBinder) {
        ...
        IEmCallback queryLocalInterface = iHwBinder.queryLocalInterface(Proxy.INTF_EM_CALLBACK_1_3);
    ...
    static IEmCallback getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EM_CALLBACK_1_3, str));
    }

    static IEmCallback getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EM_CALLBACK_1_3, str, z));
    }
