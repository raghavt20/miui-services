...
public interface IEmd extends com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd {
    ...
    public static final class Proxy implements IEmd {
        public static final String INTF_EMD_1_1 = "vendor.mediatek.hardware.engineermode@1.1::IEmd";
        ...
        @Override // com.android.server.location.hardware.mtk.engineermode.V1_1.IEmd, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        ...
        public boolean setEmConfigure(String str, String str2) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(INTF_EMD_1_1);
            hwParcel.writeString(str);
            hwParcel.writeString(str2);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{99, -93, 35, -85, -5, -25, 48, 13, -112, -127, 102, -26, 71, 112, 32, -43, 73, 58, 120, -17, -118, -84, 123, -14, -27, -42, -96, 67, -65, -69, -92, -113}, new byte[]{-66, -27, CommunicationUtil.COMMAND_MCU_BOOT, -107, 121, -115, -5, -113, -11, 28, 119, -105, 121, -100, 105, -29, 86, 105, -79, 32, -9, 25, CommunicationUtil.COMMAND_KB_NFC, -117, -93, -97, -29, -30, -10, -48, CommunicationUtil.SEND_REPORT_ID_LONG_DATA, -100}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, CommunicationUtil.RESPONSE_TYPE, 19, -109, 36, -72, 59, CommunicationUtil.MCU_ADDRESS, -54, 76}));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_1.IEmd, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(Proxy.INTF_EMD_1_1, IEmd.Proxy.INTF_EMD_1_0, IBase.kInterfaceName));
        }

        @Override // com.android.server.location.hardware.mtk.engineermode.V1_1.IEmd, com.android.server.location.hardware.mtk.engineermode.V1_0.IEmd
        public final String interfaceDescriptor() {
            return Proxy.INTF_EMD_1_1;
        }
                ...
                default:
                    switch (i) {
                        ...
                        case 45:
                            ...
                            return;
                        case 46:
                            hwParcel.enforceInterface(Proxy.INTF_EMD_1_1);
        ...
        public IHwInterface queryLocalInterface(String str) {
            if (Proxy.INTF_EMD_1_1.equals(str)) {
                return this;
            }
            return null;
        }
    ...
    static IEmd asInterface(IHwBinder iHwBinder) {
        ...
        IEmd queryLocalInterface = iHwBinder.queryLocalInterface(Proxy.INTF_EMD_1_1);
    ...
    static IEmd getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_1, str));
    }

    static IEmd getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService(Proxy.INTF_EMD_1_1, str, z));
    }
