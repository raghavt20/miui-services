...
public class XmlParser {
    public static AppCategoryConfig read(InputStream in) throws XmlPullParserException, IOException, DatatypeConfigurationException {
        ...
        if (!_tagName.equals("app-category-config")) {
            return null;
        }
        AppCategoryConfig _value = AppCategoryConfig.read(_parser);
        return _value;
    }
