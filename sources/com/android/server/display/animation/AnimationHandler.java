...
public class AnimationHandler {
    ...
    public static class FrameCallbackProvider16 extends AnimationFrameCallbackProvider {
        ...
        FrameCallbackProvider16(AnimationCallbackDispatcher dispatcher) {
            ...
            this.mChoreographerCallback = new Choreographer.FrameCallback() { // from class: com.android.server.display.animation.AnimationHandler.FrameCallbackProvider16.1
    ...
    private static class FrameCallbackProvider14 extends AnimationFrameCallbackProvider {
        ...
        FrameCallbackProvider14(AnimationCallbackDispatcher dispatcher) {
            ...
            this.mRunnable = new Runnable() { // from class: com.android.server.display.animation.AnimationHandler.FrameCallbackProvider14.1
